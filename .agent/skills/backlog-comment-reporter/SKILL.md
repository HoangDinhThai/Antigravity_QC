...
1. **Bước 1 - Drafting & Editing:** 
   - Soạn hoặc chỉnh sửa nội dung báo cáo ra file nháp local tại đường dẫn `/home/thai.hoang.dinh/SDR/backlog/draft/evidence/test-evidence-{issueKey}.md` (hoặc `test-evidence-{issueKey}-tc{X}.md`).

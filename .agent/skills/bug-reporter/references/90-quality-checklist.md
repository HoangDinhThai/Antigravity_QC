...
- [ ] Custom Fields are presented in radio-button option format (`🔘` / `[x]`) for user confirmation.
...
- [ ] Draft path is `backlog/draft/bug/bug-<feature-name>.md` (or user-specified draft path).
